package works.newsapi.arief.common.view
...
import works.newsapi.arief.common.extension.isVisible
        ...
        if (attrs != null) {
            ...
            bgColor = ContextCompat.getColor(
                ...
                if (typedArray.getInt(
                        R.styleable.Shimmer_backgroundColor,
                        0
                    ) == 0
                ) R.color.white else R.color.colorBack
            )
